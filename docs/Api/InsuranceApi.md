...
# **getInsurancePrices**
> \EveClient\Model\GetInsurancePrices200Ok[] getInsurancePrices($accept_language, $datasource, $if_none_match, $language)
...
$apiInstance = new EveClient\Api\InsuranceApi(
...
[**\EveClient\Model\GetInsurancePrices200Ok[]**](../Model/GetInsurancePrices200Ok.md)
