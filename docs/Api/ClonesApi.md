...
> \EveClient\Model\GetCharactersCharacterIdClonesOk getCharactersCharacterIdClones($character_id, $datasource, $if_none_match, $token)
...
$apiInstance = new EveClient\Api\ClonesApi(
...
[**\EveClient\Model\GetCharactersCharacterIdClonesOk**](../Model/GetCharactersCharacterIdClonesOk.md)
