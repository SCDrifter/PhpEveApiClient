...
> \EveClient\Model\GetCharactersCharacterIdFwStatsOk getCharactersCharacterIdFwStats($character_id, $datasource, $if_none_match, $token)
...
$apiInstance = new EveClient\Api\FactionWarfareApi(
...
[**\EveClient\Model\GetCharactersCharacterIdFwStatsOk**](../Model/GetCharactersCharacterIdFwStatsOk.md)
...
> \EveClient\Model\GetCorporationsCorporationIdFwStatsOk getCorporationsCorporationIdFwStats($corporation_id, $datasource, $if_none_match, $token)
...
[**\EveClient\Model\GetCorporationsCorporationIdFwStatsOk**](../Model/GetCorporationsCorporationIdFwStatsOk.md)
...
# **getFwLeaderboards**
> \EveClient\Model\GetFwLeaderboardsOk getFwLeaderboards($datasource, $if_none_match)
...
[**\EveClient\Model\GetFwLeaderboardsOk**](../Model/GetFwLeaderboardsOk.md)
...
> \EveClient\Model\GetFwLeaderboardsCharactersOk getFwLeaderboardsCharacters($datasource, $if_none_match)
...
[**\EveClient\Model\GetFwLeaderboardsCharactersOk**](../Model/GetFwLeaderboardsCharactersOk.md)
...
> \EveClient\Model\GetFwLeaderboardsCorporationsOk getFwLeaderboardsCorporations($datasource, $if_none_match)
...
[**\EveClient\Model\GetFwLeaderboardsCorporationsOk**](../Model/GetFwLeaderboardsCorporationsOk.md)
...
# **getFwStats**
> \EveClient\Model\GetFwStats200Ok[] getFwStats($datasource, $if_none_match)
...
[**\EveClient\Model\GetFwStats200Ok[]**](../Model/GetFwStats200Ok.md)
...
# **getFwSystems**
> \EveClient\Model\GetFwSystems200Ok[] getFwSystems($datasource, $if_none_match)
...
[**\EveClient\Model\GetFwSystems200Ok[]**](../Model/GetFwSystems200Ok.md)
...
# **getFwWars**
> \EveClient\Model\GetFwWars200Ok[] getFwWars($datasource, $if_none_match)
...
[**\EveClient\Model\GetFwWars200Ok[]**](../Model/GetFwWars200Ok.md)
