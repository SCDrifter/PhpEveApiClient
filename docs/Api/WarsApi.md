...
$apiInstance = new EveClient\Api\WarsApi(
...
# **getWarsWarId**
> \EveClient\Model\GetWarsWarIdOk getWarsWarId($war_id, $datasource, $if_none_match)
...
[**\EveClient\Model\GetWarsWarIdOk**](../Model/GetWarsWarIdOk.md)
...
> \EveClient\Model\GetWarsWarIdKillmails200Ok[] getWarsWarIdKillmails($war_id, $datasource, $if_none_match, $page)
...
[**\EveClient\Model\GetWarsWarIdKillmails200Ok[]**](../Model/GetWarsWarIdKillmails200Ok.md)
