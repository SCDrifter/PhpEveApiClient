...
$apiInstance = new EveClient\Api\AllianceApi(
...
> \EveClient\Model\GetAlliancesAllianceIdOk getAlliancesAllianceId($alliance_id, $datasource, $if_none_match)
...
[**\EveClient\Model\GetAlliancesAllianceIdOk**](../Model/GetAlliancesAllianceIdOk.md)
...
> \EveClient\Model\GetAlliancesAllianceIdIconsOk getAlliancesAllianceIdIcons($alliance_id, $datasource, $if_none_match)
...
[**\EveClient\Model\GetAlliancesAllianceIdIconsOk**](../Model/GetAlliancesAllianceIdIconsOk.md)
