...
class GetSovereigntyCampaigns200Ok implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'event_type' => 'string',
        'participants' => '\EveClient\Model\GetSovereigntyCampaignsParticipant[]',
        'solar_system_id' => 'int',
        'start_time' => '\DateTime',
        'structure_id' => 'int'
    ];
     ...
     * Gets participants
     *
     * @return \EveClient\Model\GetSovereigntyCampaignsParticipant[]
     */
     ...
     * Sets participants
     *
     * @param \EveClient\Model\GetSovereigntyCampaignsParticipant[] $participants Alliance participating and their respective scores, only present in Freeport Events.
     *
     * @return $this
     */
