...
class GetCharactersCharacterIdWalletJournal200Ok implements ModelInterface, ArrayAccess
{
    ...
    const REF_TYPE_DAILY_CHALLENGE_REWARD = 'daily_challenge_reward';
    ...
    const REF_TYPE_EXTERNAL_TRADE_DELIVERY = 'external_trade_delivery';
    const REF_TYPE_EXTERNAL_TRADE_FREEZE = 'external_trade_freeze';
    const REF_TYPE_EXTERNAL_TRADE_THAW = 'external_trade_thaw';
    const REF_TYPE_FACTORY_SLOT_RENTAL_FEE = 'factory_slot_rental_fee';
    const REF_TYPE_FLUX_PAYOUT = 'flux_payout';
    const REF_TYPE_FLUX_TAX = 'flux_tax';
    const REF_TYPE_FLUX_TICKET_REPAYMENT = 'flux_ticket_repayment';
    const REF_TYPE_FLUX_TICKET_SALE = 'flux_ticket_sale';
    ...
    const REF_TYPE_MARKET_PROVIDER_TAX = 'market_provider_tax';
    ...
    const REF_TYPE_MILESTONE_REWARD_PAYMENT = 'milestone_reward_payment';
    ...
    const REF_TYPE_REDEEMED_ISK_TOKEN = 'redeemed_isk_token';
    ...
    const REF_TYPE_SEASON_CHALLENGE_REWARD = 'season_challenge_reward';
