...
class IncursionsApi
{
     ...
     * @return \EveClient\Model\GetIncursions200Ok[]
     */
     ...
     * @throws \EveClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \EveClient\Model\GetIncursions200Ok[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getIncursionsWithHttpInfo($datasource = 'tranquility', $if_none_match = null)
    {
        $returnType = '\EveClient\Model\GetIncursions200Ok[]';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\EveClient\Model\GetIncursions200Ok[]',
