...
class PlanetaryInteractionApi
{
     ...
     * @return \EveClient\Model\GetCharactersCharacterIdPlanets200Ok[]
     */
     ...
     * @throws \EveClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \EveClient\Model\GetCharactersCharacterIdPlanets200Ok[], HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\EveClient\Model\GetCharactersCharacterIdPlanets200Ok[]';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\EveClient\Model\GetCharactersCharacterIdPlanets200Ok[]',
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\EveClient\Model\GetCharactersCharacterIdPlanetsPlanetIdOk',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
                ...
                case 404:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\EveClient\Model\GetCharactersCharacterIdPlanetsPlanetIdNotFound',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \EveClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \EveClient\Model\GetCorporationsCorporationIdCustomsOffices200Ok[]
     */
     ...
     * @throws \EveClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \EveClient\Model\GetCorporationsCorporationIdCustomsOffices200Ok[], HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\EveClient\Model\GetCorporationsCorporationIdCustomsOffices200Ok[]';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\EveClient\Model\GetCorporationsCorporationIdCustomsOffices200Ok[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \EveClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \EveClient\Model\GetUniverseSchematicsSchematicIdOk
     */
     ...
     * @throws \EveClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \EveClient\Model\GetUniverseSchematicsSchematicIdOk, HTTP status code, HTTP response headers (array of strings)
     */
    public function getUniverseSchematicsSchematicIdWithHttpInfo($schematic_id, $datasource = 'tranquility', $if_none_match = null)
    {
        $returnType = '\EveClient\Model\GetUniverseSchematicsSchematicIdOk';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\EveClient\Model\GetUniverseSchematicsSchematicIdOk',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
                ...
                case 404:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\EveClient\Model\GetUniverseSchematicsSchematicIdNotFound',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
