...
class FleetsApi
{
        ...
        try {
            ...
            switch ($e->getCode()) {
                ...
                case 404:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\EveClient\Model\DeleteFleetsFleetIdMembersMemberIdNotFound',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
        ...
        try {
            ...
            switch ($e->getCode()) {
                ...
                case 404:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\EveClient\Model\DeleteFleetsFleetIdSquadsSquadIdNotFound',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
        ...
        try {
            ...
            switch ($e->getCode()) {
                ...
                case 404:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\EveClient\Model\DeleteFleetsFleetIdWingsWingIdNotFound',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \EveClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \EveClient\Model\GetCharactersCharacterIdFleetOk
     */
     ...
     * @throws \EveClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \EveClient\Model\GetCharactersCharacterIdFleetOk, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\EveClient\Model\GetCharactersCharacterIdFleetOk';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\EveClient\Model\GetCharactersCharacterIdFleetOk',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
                ...
                case 404:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\EveClient\Model\GetCharactersCharacterIdFleetNotFound',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \EveClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \EveClient\Model\GetFleetsFleetIdOk
     */
     ...
     * @throws \EveClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \EveClient\Model\GetFleetsFleetIdOk, HTTP status code, HTTP response headers (array of strings)
     */
    public function getFleetsFleetIdWithHttpInfo($fleet_id, $datasource = 'tranquility', $if_none_match = null, $token = null)
    {
        $returnType = '\EveClient\Model\GetFleetsFleetIdOk';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\EveClient\Model\GetFleetsFleetIdOk',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
                ...
                case 404:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\EveClient\Model\GetFleetsFleetIdNotFound',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \EveClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \EveClient\Model\GetFleetsFleetIdMembers200Ok[]
     */
     ...
     * @throws \EveClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \EveClient\Model\GetFleetsFleetIdMembers200Ok[], HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\EveClient\Model\GetFleetsFleetIdMembers200Ok[]';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\EveClient\Model\GetFleetsFleetIdMembers200Ok[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
                ...
                case 404:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\EveClient\Model\GetFleetsFleetIdMembersNotFound',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getFleetsFleetIdMembersRequest($fleet_id, $accept_language = 'en', $datasource = 'tranquility', $if_none_match = null, $language = 'en', $token = null)
    {
        // verify the required parameter 'fleet_id' is set
        if ($fleet_id === null || (is_array($fleet_id) && count($fleet_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @throws \EveClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \EveClient\Model\GetFleetsFleetIdWings200Ok[]
     */
     ...
     * @throws \EveClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \EveClient\Model\GetFleetsFleetIdWings200Ok[], HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\EveClient\Model\GetFleetsFleetIdWings200Ok[]';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\EveClient\Model\GetFleetsFleetIdWings200Ok[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
                ...
                case 404:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\EveClient\Model\GetFleetsFleetIdWingsNotFound',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getFleetsFleetIdWingsRequest($fleet_id, $accept_language = 'en', $datasource = 'tranquility', $if_none_match = null, $language = 'en', $token = null)
    {
        // verify the required parameter 'fleet_id' is set
        if ($fleet_id === null || (is_array($fleet_id) && count($fleet_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     *
     * @param  int $fleet_id ID for a fleet (required)
     * @param  \EveClient\Model\PostFleetsFleetIdMembersInvitation $invitation Details of the invitation (required)
     * @param  string $datasource The server name you would like data from (optional, default to tranquility)
     * @param  string $token Access token to use if unable to set a header (optional)
     *
     * @throws \EveClient\ApiException on non-2xx response
        ...
        try {
            ...
            switch ($e->getCode()) {
                ...
                case 404:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\EveClient\Model\PostFleetsFleetIdMembersNotFound',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
                ...
                case 422:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\EveClient\Model\PostFleetsFleetIdMembersUnprocessableEntity',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \EveClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \EveClient\Model\PostFleetsFleetIdWingsCreated
     */
     ...
     * @throws \EveClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \EveClient\Model\PostFleetsFleetIdWingsCreated, HTTP status code, HTTP response headers (array of strings)
     */
    public function postFleetsFleetIdWingsWithHttpInfo($fleet_id, $datasource = 'tranquility', $token = null)
    {
        $returnType = '\EveClient\Model\PostFleetsFleetIdWingsCreated';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\EveClient\Model\PostFleetsFleetIdWingsCreated',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
                ...
                case 404:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\EveClient\Model\PostFleetsFleetIdWingsNotFound',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \EveClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \EveClient\Model\PostFleetsFleetIdWingsWingIdSquadsCreated
     */
     ...
     * @throws \EveClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \EveClient\Model\PostFleetsFleetIdWingsWingIdSquadsCreated, HTTP status code, HTTP response headers (array of strings)
     */
    public function postFleetsFleetIdWingsWingIdSquadsWithHttpInfo($fleet_id, $wing_id, $datasource = 'tranquility', $token = null)
    {
        $returnType = '\EveClient\Model\PostFleetsFleetIdWingsWingIdSquadsCreated';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\EveClient\Model\PostFleetsFleetIdWingsWingIdSquadsCreated',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
                ...
                case 404:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\EveClient\Model\PostFleetsFleetIdWingsWingIdSquadsNotFound',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  int $fleet_id ID for a fleet (required)
     * @param  \EveClient\Model\PutFleetsFleetIdNewSettings $new_settings What to update for this fleet (required)
     * @param  string $datasource The server name you would like data from (optional, default to tranquility)
     * @param  string $token Access token to use if unable to set a header (optional)
     *
     * @throws \EveClient\ApiException on non-2xx response
        ...
        try {
            ...
            switch ($e->getCode()) {
                ...
                case 404:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\EveClient\Model\PutFleetsFleetIdNotFound',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  int $fleet_id ID for a fleet (required)
     * @param  int $member_id The character ID of a member in this fleet (required)
     * @param  \EveClient\Model\PutFleetsFleetIdMembersMemberIdMovement $movement Details of the invitation (required)
     * @param  string $datasource The server name you would like data from (optional, default to tranquility)
     * @param  string $token Access token to use if unable to set a header (optional)
     *
     * @throws \EveClient\ApiException on non-2xx response
        ...
        try {
            ...
            switch ($e->getCode()) {
                ...
                case 404:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\EveClient\Model\PutFleetsFleetIdMembersMemberIdNotFound',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
                ...
                case 422:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\EveClient\Model\PutFleetsFleetIdMembersMemberIdUnprocessableEntity',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  int $fleet_id ID for a fleet (required)
     * @param  \EveClient\Model\PutFleetsFleetIdSquadsSquadIdNaming $naming New name of the squad (required)
        ...
        try {
            ...
            switch ($e->getCode()) {
                ...
                case 404:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\EveClient\Model\PutFleetsFleetIdSquadsSquadIdNotFound',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  int $fleet_id ID for a fleet (required)
     * @param  \EveClient\Model\PutFleetsFleetIdWingsWingIdNaming $naming New name of the wing (required)
        ...
        try {
            ...
            switch ($e->getCode()) {
                ...
                case 404:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\EveClient\Model\PutFleetsFleetIdWingsWingIdNotFound',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
