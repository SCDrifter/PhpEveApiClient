...
class StatusApi
{
     ...
     * @return \EveClient\Model\GetStatusOk
     */
     ...
     * @throws \EveClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \EveClient\Model\GetStatusOk, HTTP status code, HTTP response headers (array of strings)
     */
    public function getStatusWithHttpInfo($datasource = 'tranquility', $if_none_match = null)
    {
        $returnType = '\EveClient\Model\GetStatusOk';
