...
class InsuranceApi
{
     ...
     * @return \EveClient\Model\GetInsurancePrices200Ok[]
     */
     ...
     * @throws \EveClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \EveClient\Model\GetInsurancePrices200Ok[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getInsurancePricesWithHttpInfo($accept_language = 'en', $datasource = 'tranquility', $if_none_match = null, $language = 'en')
    {
        $returnType = '\EveClient\Model\GetInsurancePrices200Ok[]';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\EveClient\Model\GetInsurancePrices200Ok[]',
     ...
     */
    protected function getInsurancePricesRequest($accept_language = 'en', $datasource = 'tranquility', $if_none_match = null, $language = 'en')
    {
