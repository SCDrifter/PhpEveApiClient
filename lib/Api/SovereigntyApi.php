...
class SovereigntyApi
{
     ...
     * @return \EveClient\Model\GetSovereigntyCampaigns200Ok[]
     */
     ...
     * @throws \EveClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \EveClient\Model\GetSovereigntyCampaigns200Ok[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getSovereigntyCampaignsWithHttpInfo($datasource = 'tranquility', $if_none_match = null)
    {
        $returnType = '\EveClient\Model\GetSovereigntyCampaigns200Ok[]';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\EveClient\Model\GetSovereigntyCampaigns200Ok[]',
     ...
     * @throws \EveClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \EveClient\Model\GetSovereigntyMap200Ok[]
     */
     ...
     * @throws \EveClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \EveClient\Model\GetSovereigntyMap200Ok[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getSovereigntyMapWithHttpInfo($datasource = 'tranquility', $if_none_match = null)
    {
        $returnType = '\EveClient\Model\GetSovereigntyMap200Ok[]';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\EveClient\Model\GetSovereigntyMap200Ok[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \EveClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \EveClient\Model\GetSovereigntyStructures200Ok[]
     */
     ...
     * @throws \EveClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \EveClient\Model\GetSovereigntyStructures200Ok[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getSovereigntyStructuresWithHttpInfo($datasource = 'tranquility', $if_none_match = null)
    {
        $returnType = '\EveClient\Model\GetSovereigntyStructures200Ok[]';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\EveClient\Model\GetSovereigntyStructures200Ok[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
